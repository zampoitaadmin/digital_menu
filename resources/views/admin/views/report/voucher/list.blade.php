        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="new">
                <ol class="breadcrumb pl-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin-report-voucher-list') }}">Report Vouchers</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Report Vouchers List</li>
                </ol>
            </nav>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        if($('#data-table-4').length > 0)
        {
            list_table_one = $('#data-table-4').DataTable(
            {
                ...
                "ajax":{
                    "url": "{{ route('admin-report-voucher-lists') }}",
                    "type": "POST",
                    "dataType": "json",
                    "data":{
                        _token: "{{csrf_token()}}"
    ...
    function change_status(a_object){
        ...
        $.ajax({
            "url": "{!! route('admin-report-voucher-change-status') !!}",
            "dataType": "json",
            "type": "POST",
            "data":{
                id: id,
