                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h2 center pb10" style="color:#595a5d; font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:1.2; text-align:center; padding-bottom:30px;text-transform: uppercase;">Hi {{ $varGreetingName }},
                                                        <br>  Order Id: #{{$changeStatusData->code}} <br>
                                                        </td>         
                                                    </tr>
                                                    <tr>
                                                        <td class="h2 center pb10" style="color:#595a5d; font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:1.2; text-align:center; padding-bottom:50px;text-transform: none;">
                                                        @if($changeStatusData->order_status == 1)
                                                                        Order is under "Processing"
                                                                     @elseif($changeStatusData->order_status == 2)
                                                                       Your proof has now been emailed to you for your new fantastic slate sign, can you please let us know via that email if all is ok? or if we need to make any changes please
                                                                  @elseif($changeStatusData->order_status == 3)
                                                                       Just a quick message to let you know we are currently engraving your sign and will let you know once its completed
                                                                    @elseif($changeStatusData->order_status == 4)
                                                                         Upon completion of your sign we noticed that the quality wasn’t upto our usual standard, it has therefore gone back into production to be corrected.  If you have received a tracking information email you may notice it wont update in the short term.  Once the status has been changed back to COMPLETED again your sign will be sent on its way as normal.  We apologise for the delay and will be keeping you informed.
                                                                   @elseif($changeStatusData->order_status == 5)
                                                                         Great news! Your sign is all ready to go and you will soon receive a tracking information email with the courier details, please keep an eye on any email spam/junk folders just in case, thanks again for your order.                     
                                                                    @endif           
                                                        </td>         
                                                    </tr>
                                                    <tr>
