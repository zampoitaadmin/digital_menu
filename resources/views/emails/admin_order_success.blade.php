                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h2 center pb10" style="color:#595a5d; font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:60px; text-align:center; padding-bottom:10px;text-transform: uppercase;">Hi Administrator, New order placed successfully!</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="h2 center pb10" style="color:#595a5d; font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:60px; text-align:center; padding-bottom:10px;text-transform: uppercase;">
                                                    ...
                                                    @if($cartArray->totalProductCount)
                                                        <tr>
                                                            <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:18px; line-height:26px; text-align:center; color:#595a5d; padding-bottom:10px;text-transform: none;font-style: normal;font-weight: 500;padding-top: 40px;">
                                                                <p>Delivery: Yes</p>
                                                    ...
                                                    <tr>
                                                        <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:18px; line-height:26px; text-align:center; color:#595a5d; padding-bottom:10px;text-transform: none;font-style: normal;font-weight: 500;padding-top: 40px;">Shipping Details:</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:18px; line-height:26px; text-align:center; color:#595a5d; padding-bottom:50px;text-transform: none;font-style: normal;font-weight: lighterå;padding-top: 0;">
                                                             {{ $varGreetingName }} <br>
