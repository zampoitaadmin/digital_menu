    ...
    <div class="img-100">
        ...
        <div class="voucher_code_section" style="">
            ...
            <div id="email" class="cls_receipt_email" >
                ...
                <br><br><br>
                <p>Address line 1</p>
                <input type="text" name="shippingAddressLine1"  ng-model="checkoutRequestData.shippingAddressLine1"
                       ng-model-options="{ debounce: 1500 }" ng-change="saveShippingDetailsFun()" autocomplete="no-fill">
                <span class="help-block" ng-if="checkoutRequestDataError.shippingAddressLine1">
                    @{{ checkoutRequestDataError.shippingAddressLine1}}
                </span>
                <br><br><br>
                <p>Address line 2 (Optional)</p>
                <input type="text" name="shippingAddressLine2"  ng-model="checkoutRequestData.shippingAddressLine2"
                       ng-model-options="{ debounce: 1500 }" ng-change="saveShippingDetailsFun()" autocomplete="no-fill">
                <span class="help-block" ng-if="checkoutRequestDataError.shippingAddressLine2">
                    @{{ checkoutRequestDataError.shippingAddressLine2}}
                </span>
                <br><br><br>
                <p>City</p>
                <input type="text" name="shippingCity"  ng-model="checkoutRequestData.shippingCity"
                       ng-model-options="{ debounce: 1500 }" ng-change="saveShippingDetailsFun()" autocomplete="no-fill">
                <span class="help-block" ng-if="checkoutRequestDataError.shippingCity">
                    @{{ checkoutRequestDataError.shippingCity}}
                </span>
                <br><br><br>
        ...
        <div class="payment_method_section" style="" ng-if="cartData.total_payable>0">
            ...
            <div class="inp">
                ...
                <div class="item">
                    ...
                    <input type="radio" name="rd_payment_method" value="Manual" checked="checked"  ng-checked="paymentMethodType =='Manual'"  ng-model="paymentMethodType" ng-change="changePaymentMethodTypeFun('Manual')"><span
